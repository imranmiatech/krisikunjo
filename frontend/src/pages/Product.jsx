      ...
      <div className='flex gap-12 sm:gap-12 flex-col sm:flex-row '>
             ...
             <div className='flex-1'>
              ...
              <div className='text-sm text-gray-500 mt-5 flex flex-col gap-1'>
                  <p>কিছু পন্য ২ মাস পরে ডেলিভারি দেওয়া হয়,যেগুলো দেশের বাহির হতে আমদানীকৃত। </p>
                  <p>আমদানীকৃত পন্য ব্যাতিত বাকি পন্যগুলো ২-৪ দিনের ভিতর ডেলিভারি দেওয়া হয়।</p>
                  <p>👉অগ্রীম মূল্য পরিশোধ করিতে হবে।</p>
                  <p>প্রয়োজনে অর্ডার করার পূর্বে যোগাযোগ করুন। ফোন : <a   href="tel:+8801739299521"
                   className="hover:text-blue-600 transition-colors"
                   aria-label="Call us at +88 01739299521">+88 01739299521</a></p>
              </div>
             </div>
      </div>
